...
//
            'home: title' => "Bem-vind@ a Amunesc Cultural!",
            'home: abbreviation' => "AC",
//            'home: colabore' => "Colabore com o Mapas Culturais",
            'home: welcome' => "Amunesc Cultural é o mapa cultural dos municípios associados da Amunesc. Foi criado com o objetivo de reunir em uma só plataforma livre, gratuita e colaborativa a diversidade da cultura do Nordeste Catarinense.  Assim, as opções culturais que Araquari, Balneário Barra do Sul, Campo Alegre, Garuva, Itapoá, Joinville, Rio Negrinho, São Bento do Sul e São Francisco do Sul oferecem estão aqui. Ficou mais fácil conhecer os  <a href=\"{$url_search_events}\">eventos</a>, <a href=\"{$url_search_spaces}\">espaços</a> ou <a href=\"$url_search_projects\">projetos</a> da região. Você também pode colaborar na difusão da cultura da nossa região. Crie seu perfil de <a href=\"$url_search_agents\" >agente cultural</a>.",
